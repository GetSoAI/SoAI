...
class ChatConfigurationController implements EditableConfigurationSessionState {
    ...
    async #retryProjectionEffects(): Promise<boolean> {
        const emptyCommit = { committed: false, backendDefaultsChanged: false, richTextChanged: false, senderLabelChanged: false, inputActionsChanged: false, sendHotkeyChanged: false, toolsEnabledChanged: false, toolApprovalRequiredChanged: false, conversationListFiltersChanged: false, activityDurationDisplayChanged: false };
