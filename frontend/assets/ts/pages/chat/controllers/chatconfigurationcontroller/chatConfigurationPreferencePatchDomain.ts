...
const SERIALIZED_CONFIGURATION_PREFERENCE_PARAMETER_KEYS = Object.freeze(['conversationPdfExportEnabled', 'newConversationInheritLastSettings', 'ctrlEnterSendEnabled', 'richTextEnabled', 'inlineMultimediaPreviewsEnabled', 'autoTitleGeneration', 'showActivities', 'showActivityElapsedTime', 'hideAutomationRuns', 'hideMessagingConversations', 'notifyOnCompletion', 'notifyOnError', 'microphoneSoundEffectsEnabled', 'inputActionVoiceEnabled', 'inputActionCallEnabled', 'inputActionFileUploadEnabled', 'inputActionCameraEnabled', 'inputActionPromptsEnabled', 'inputActionTokenCounterEnabled', 'inputActionNewConversationEnabled', 'inputActionCharacterMapEnabled', 'inputActionMobileAuxiliaryAction', 'voiceTtsModel', 'voiceSttModel'] satisfies readonly ChatParameterKey[]);
