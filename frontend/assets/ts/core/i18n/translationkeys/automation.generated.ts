/* SoAI - Frontend core Translation declarations for the `automation` namespace [frontend/assets/ts/core/i18n/translationkeys/automation.generated.ts] */
...
import type { AutomationPlaceholdersTranslationKey } from '@core/i18n/translationkeys/automation/placeholders.generated.ts';
import type { AutomationPreferencesCorruptTranslationKey } from '@core/i18n/translationkeys/automation/preferencesCorrupt.generated.ts';
import type { AutomationRecurrenceTranslationKey } from '@core/i18n/translationkeys/automation/recurrence.generated.ts';
import type { AutomationStatusTranslationKey } from '@core/i18n/translationkeys/automation/status.generated.ts';
