...
def build_application_controller_services(
    ...
    server_coordinator = ApplicationServerCoordinator(
        ApplicationServerCoordinatorDependencies(
            ...
            hardware_manager=deps.services.infrastructure.hw_manager,
            cancellation_binder=deps.services.tasks.task_cancellation_binder,
            finalizer_tracker=deps.services.tasks.task_finalizer_tracker,
