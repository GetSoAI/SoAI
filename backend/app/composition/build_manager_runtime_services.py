...
def build_manager_runtime_services(
    *,
    ...
    mcp_coordinator_instance = build_mcp_services_coordinator(
        ...
        storage_manager=infrastructure_services.storage_manager,
        hardware_manager=infrastructure_services.hw_manager,
        hardware_control=infrastructure_services.hardware_control,
        hardware_soaibench=infrastructure_services.hardware_soaibench,
        terminal=infrastructure_services.terminal,
        ...
        external_accounts=infrastructure_services.external_accounts,
        mail_accounts=infrastructure_services.mail_accounts,
        calendar_accounts=infrastructure_services.calendar_accounts,
        mail=infrastructure_services.mail,
        calendar=infrastructure_services.calendar,
