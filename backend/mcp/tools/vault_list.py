"""SoAI - MCP utility tool: vault_list [backend/mcp/tools/vault_list.py]"""
...
__all__ = ("tool_vault_list",)


async def tool_vault_list(utility_tools: MCPUtilityToolsProtocol, _arguments: JSONDict) -> JSONDict:
    user_id = require_authenticated_user_id(utility_tools, tool_name="vault_list")
