"""SoAI - Canonical current database schema objects [backend/database/current_schema_objects.py]"""
...
__all__ = ("apply_current_schema_objects",)
...
def apply_current_schema_objects(
