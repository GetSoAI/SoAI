...
WEBUI_ROUTE_REGISTRARS: tuple[Callable[[ApiRouters], None], ...] = (
    ...
    conversation_message_regeneration_routes.register_routes,
    ...
    conversation_stream_cancel_route.register_routes,
