...
def build_api_dependencies(
    ...
    *,
    ...
    api_dependencies = ApiDependencies(
        ...
        cancellation_coordinator=services.tasks.cancellation_coordinator,
        cancellation_history=services.tasks.cancellation_history,
        cancellation_event_bus=services.tasks.cancellation_event_bus,
        token_collection=services.tasks.token_collection,
        task_cancellation_binder=services.tasks.task_cancellation_binder,
        task_finalizer_tracker=services.tasks.task_finalizer_tracker,
        ...
        hw_manager=services.infrastructure.hw_manager,
        hw_gpu_tuning=services.infrastructure.hw_gpu_tuning,
        hardware_control=services.infrastructure.hardware_control,
        hardware_soaibench=services.infrastructure.hardware_soaibench,
        terminal=services.infrastructure.terminal,
        storage_manager=services.infrastructure.storage_manager,
        ...
        external_accounts=services.infrastructure.external_accounts,
        mail_accounts=services.infrastructure.mail_accounts,
        calendar_accounts=services.infrastructure.calendar_accounts,
        mail=services.infrastructure.mail,
        calendar=services.infrastructure.calendar,
